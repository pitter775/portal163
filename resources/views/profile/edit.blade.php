        ...
        <div class="row">
            ...
            <div class="col-md-8 text-center">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Email" value="{{ auth()->user()->email }}" disabled  required>
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Salvar Alterações') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form class="col-md-12" action="{{ route('profile.password') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Mudar a Senha') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Confirmar Senha') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
